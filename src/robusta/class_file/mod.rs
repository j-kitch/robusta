...
impl<R: io::BufRead> Reader<R> {
    ...
    pub fn read_attribute(&mut self, const_pool: &HashMap<u16, Const>) -> Result<Attribute, Error> {
        ...
        match name.as_str() {
            ...
            "Exceptions" => Ok(Attribute::Unknown(self.read_unknown(name.as_str())?)),
            "InnerClasses" => Ok(Attribute::Unknown(self.read_unknown(name.as_str())?)),
            "EnclosingMethod" => Ok(Attribute::Unknown(self.read_unknown(name.as_str())?)),
            "Synthetic" => Ok(Attribute::Unknown(self.read_unknown(name.as_str())?)),
            "Signature" => Ok(Attribute::Signature(self.read_signature()?)),
            "SourceFile" => Ok(Attribute::Unknown(self.read_unknown(name.as_str())?)),
            "SourceDebugExtension" => Ok(Attribute::Unknown(self.read_unknown(name.as_str())?)),
            ...
            "Deprecated" => Ok(Attribute::Unknown(self.read_unknown(name.as_str())?)),
            "RuntimeVisibleAnnotations" => Ok(Attribute::RuntimeVisibleAnnotations(self.read_runtime_annotations()?)),
            "RuntimeInvisibleAnnotations" => Ok(Attribute::RuntimeInvisibleAnnotations(self.read_runtime_annotations()?)),
            "RuntimeVisibleParameterAnnotations" => Ok(Attribute::RuntimeVisibleParameterAnnotations(self.read_runtime_parameter_annotations()?)),
            "RuntimeInvisibleParameterAnnotations" => Ok(Attribute::RuntimeInvisibleParameterAnnotations(self.read_runtime_parameter_annotations()?)),
            "RuntimeVisibleTypeAnnotations" => Ok(Attribute::Unknown(self.read_unknown(name.as_str())?)),
            "RuntimeInvisibleTypeAnnotations" => Ok(Attribute::Unknown(self.read_unknown(name.as_str())?)),
            "AnnotationDefault" => Ok(Attribute::Unknown(self.read_unknown(name.as_str())?)),
            ...
            _ => Ok(Attribute::Unknown(self.read_unknown(name.as_str())?)),
        }
    }
